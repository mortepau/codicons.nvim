...
Welcome and thank you for considering contributing to codicons.nvim. People like
you are what make projects like codicons.nvim improve and always stay
up-to-date.
...
contributing to this project, you agree to uphold our [Code of Conduct](./CODE_OF_CONDUCT.md).
...
can also help by indicating to our maintainers that a particular problem is
...
- Include documentation in the code, [README.md](./README.md) and/or [docs](./doc/codicons.txt)
  when applicable.
